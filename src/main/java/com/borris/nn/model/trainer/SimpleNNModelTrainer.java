package com.borris.nn.model.trainer;
...
public class SimpleNNModelTrainer implements ModelTrainer {
    private static final Path preTrainedModelPath = ConfigConstants.PRE_TRAINED_MODEL_PATH.resolve("simplePreTrainedModelMnist.zip");
    ...
    private void preTrain() {
        ...
        for (int i = 1; i < ConfigConstants.EPOCHS ; i++) {
