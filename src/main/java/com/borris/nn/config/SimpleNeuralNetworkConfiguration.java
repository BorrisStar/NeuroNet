...
public class SimpleNeuralNetworkConfiguration {
    ...
    public MultiLayerConfiguration neuralNetConfiguration(Nesterovs nesterovs) {
        return new NeuralNetConfiguration.Builder()
                ...
                .list()
                    ...
                    .layer(2, outputLayer())
                .setInputType(InputType.convolutional(ConfigConstants.IMAGE_HEIGHT, ConfigConstants.IMAGE_WIDTH, ConfigConstants.CHANNELS)) // see comments ConvolutionNeuralNetworkConfiguration.java
                .build();
    }
    ...
    public Layer inputLayer() {
        return new DenseLayer.Builder()
                ...
                .nIn(ConfigConstants.IMAGE_WIDTH * ConfigConstants.IMAGE_HEIGHT)
                .nOut(128)
                .build();
    }
